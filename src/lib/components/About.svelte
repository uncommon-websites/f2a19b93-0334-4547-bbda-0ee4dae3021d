<script lang="ts">
  const founderImage = 'https://openstakes.com/wp-content/themes/openstakes_2024/img/main-page/max_1.webp';
</script>

<section class="py-32 px-6 max-w-[1400px] mx-auto border-t border-gray-200" id="about">
